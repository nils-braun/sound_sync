...
class TestBufferListHandler(TestCase):
    def test_add_buffer(self):
        ...
        self.assertEqual(buffer_list_handler.add_buffer("test0"), 0)
        self.assertEqual(buffer_list_handler.add_buffer("test1"), 1)
        self.assertEqual(buffer_list_handler.add_buffer("test2"), 2)
